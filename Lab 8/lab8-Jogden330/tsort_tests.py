...
class TestTsort(unittest.TestCase):
    ...
    def test_Empty_input(self):
        ...
        with self.assertRaises(ValueError) as cm:
                tsort(input).fail()
        self.assertEqual(
                "input contains no edges",
                str(cm.exception))

    def test_odd_input(self):
        input =  ['t1', 't2', 't2', 't4', 't1', 't3', 't3']
        with self.assertRaises(ValueError) as cm:
                tsort(input).fail()
        self.assertEqual(
    ...
    #
    #     input = ['t1', 't2', 't2', 't4', 't1', 't3', 't3', 't4']
    #
    #     actual = bulid_adjacency_dictionary(input)
    #     adj = adjacency()
    #     adj.degree = 0
    #     adj.adjacency_list = ["t2", "t3"]
    #     self.assertEqual(actual.get('t1'), adj)
    #
    #     adj.degree = 1
    #     adj.adjacency_list = ["t4"]
    #     self.assertEqual(actual.get('t2'), adj)
    #
    #     adj.degree = 1
    #     adj.adjacency_list = ["t4"]
    #     self.assertEqual(actual.get('t3'), adj)
    #
    #     adj.degree = 2
    #     adj.adjacency_list = []
    #     self.assertEqual(actual.get('t4'), adj)
